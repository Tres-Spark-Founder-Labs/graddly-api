...
6. `on_track` — OTJ pace `on_track`
7. `pace_unknown` — OTJ pace missing. **Not in F2.2.1 AC3**: a recorded
   deviation, [D-01](prd/DEVIATIONS.md). This used to be the default and fell
   through to `on_track`.
